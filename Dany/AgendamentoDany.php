                    ...
                    echo "<td>
                              ...
                              <a class='btn btn-sm btn-danger' href='deleteDany.php?id=$user_data[id_agendamentoDany]'>
                                <svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-trash-fill' viewBox='0 0 16 16'>
                                  <path d='M2.5 1a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1H3v9a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V4h.5a.5.5 0 0 0 .5-.5V2a1 1 0 0 0-1-1H10a1 1 0 0 0-1-1H7a1 1 0 0 0-1 1zm3 4a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 .5-.5M8 5a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7A.5.5 0 0 1 8 5m3 .5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 1 0'/>
                                </svg>
                              </a>
                          </td>";
                    echo "</tr>";
...
<script>var search = document.getElementById('pesquisar');
...
<script src="https://cdn.jsdelivr.net/npm/@popperjs/core@2.11.6/dist/umd/popper.min.js" integrity="sha384-56ZGwjRFSvFfE0IfD8r+vk+n28PYxx5lQ3mY/KtOxPpi2V4aJesC/ZhIGbFuyvRr" crossorigin="anonymous"></script>
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.min.js" integrity="sha384-J5pqhmEQ1hgjK1LrZGJwzko44MQ4wzr3S/cr+HD/FkXP0yMbVnBO2kEK4JxgEFxu" crossorigin="anonymous"></script>
</body>
</html>
