<?php
      ...
      if(isset($_POST['submit']))
      {
          ...
          try {
                      $consulta = "SELECT COUNT(*) AS registro FROM agendamentos_dany WHERE horario = '$horario' AND data_agendamento = '$data_agendamento'";
                      ...
                      if ($resultado)
                          ...
                          if ($row['registro'] > 0) {
                              ...
                              mysqli_commit($conexao);
                                ...
                                $query = "INSERT INTO agendamentos_dany (nome, email, telefone, sexo, data_agendamento, horario, plano, recado, liberado) 
...
<!---------------------------------------//-------------HEADER---------------------//------------------------------------------>
    ...
    <header class="cabecalho-header" id="home-header">
      ...
      <div>
          <a href="../Dany/AgendamentoDany.php"><h3 class="agendamentos">Meus Agendamentos</h3></a>
        </div>
...
<!---------------------------------------//------------- PRAZER, DANY! :) ---------------------//------------------------------------------>
    ...
    <main id="container">
      <div class="sobre">
        <div>
          <h2 id="sobre" class="titulo-main">PRAZER, SOU A DANY!  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-balloon-heart" viewBox="0 0 16 16">
        ...
        <section class="container1"> 
          ...
          <div class="content">
            <img src="../img/danipsyco.png" alt="Imagem">
            <p>Em minha prática como psicóloga, tenho como abordagem principal a Terapia Cognitivo-Comportamental (TCC), uma metodologia que me permite auxiliar meus pacientes a identificar e modificar padrões de pensamento e comportamento que causam desconforto e sofrimento emocional. Meu consultório é um espaço acolhedor e seguro, projetado para inspirar confiança e promover o autoconhecimento.<br><br>Cada detalhe do ambiente foi pensado para criar uma atmosfera de tranquilidade e bem-estar. Desde as cores suaves das paredes até a disposição dos móveis, tudo foi escolhido com cuidado para proporcionar um ambiente propício à reflexão e ao crescimento pessoal.<br><br>Os tratamentos que ofereço são personalizados para atender às necessidades específicas de cada paciente. Utilizando técnicas e estratégias da TCC, trabalhamos juntos para identificar pensamentos negativos e padrões de comportamento disfuncionais, desenvolvendo habilidades para lidar com o estresse, superar dificuldades e alcançar objetivos pessoais.<br><br>Meu consultório não é apenas um espaço físico, mas sim um local de transformação e renovação. É um convite para uma jornada de autodescoberta e crescimento, onde cada indivíduo é encorajado a explorar seu potencial e encontrar o equilíbrio emocional. Estou aqui para oferecer apoio, orientação e as ferramentas necessárias para que meus pacientes possam viver uma vida mais plena e satisfatória.<br><br> Seja Bem-vindo(a)<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-balloon-heart-fill" viewBox="0 0 16 16">
...
<!---------------------------------------//-------------FORMULÁRIO---------------------//------------------------------------------>
        ...
        <div class="caixa">
        <form action="Dany.php" method="POST" autocomplete="off">
          <fieldset>
